...
- **Ассоциативный образ:** бронь с правом решить позже; образ объясняет ценность времени, но не заменяет модель ценообразования

## Rejection criteria

- единица, шапка или сине-зелёная кисточка перестали соответствовать identity reference;
- формулы CALL/PUT перепутаны;
- пример не складывается как `8 = 5 + 3`;
- временная стоимость показана отдельной комиссией;
- сказано, что распад всегда линейный или что цена обязана падать каждый день;
